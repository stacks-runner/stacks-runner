 ...
 * Note: These are frontend unit tests, not Clarity contract tests
 * Run with: npm run test:frontend (after setup)
 */

// Temporarily disabled - requires separate jest/vitest config for frontend tests
describe.skip('ContractAPI', () => {
  let contractAPI;
